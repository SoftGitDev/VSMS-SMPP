...
public abstract class OptionalParameter {
	...
	public enum Addr_subunit{
        ...
        /**
	 * This will help the system execute overall scrubbing model
	 * In case of future customer complaints, PE will be held responsible for any message which has gone. <br>
	 * <br>
	 * API Tag Name: PE_ID, DLT_PE_ID
	 * @author soft-tech
	 *
	 */
        public static class Principal_Entity_ID extends OptionalParameter.OctetString {
            
            public Principal_Entity_ID() {
		this("".getBytes());
            }
            
            public Principal_Entity_ID(byte[] value) {
		super(Tag.PE_ID.code(), value);
            }
	}
        
        
        public static class Template_ID extends OptionalParameter.OctetString {
		...
		this("".getBytes());
            ...
            public Template_ID(byte[] value) {
		super(Tag.TEMPLATE_ID.code(), value);
            }
	}
        
        
        public static class Telemarketer_ID extends OptionalParameter.OctetString {
            
             public Telemarketer_ID() {
		this("".getBytes());
            }
            
            public Telemarketer_ID(byte[] value) {
		super(Tag.TELEMARKETER_ID.code(), value);
            }
	}
    ...
    public enum Tag {
        ...
        //14-09-2020 Optional Parameter
        PE_ID(0x1400, Principal_Entity_ID.class),
        TEMPLATE_ID(0x1401, Template_ID.class),
        TELEMARKETER_ID(0x1402, Telemarketer_ID.class),
        /*********/

 ...
 * @author SUTHAR
 */
public class ValidityPeriodFormatter implements TimeFormatter {

    /**
     * Time/Date ASCII format for Validity Period Time Format is:
     *
    ...
    public String format(Calendar calendar, int min) {
        if (calendar == null) {
            return null;
        }
    ...
    public String format(Date date, int min) {
        if (date == null) {
            return null;
        }

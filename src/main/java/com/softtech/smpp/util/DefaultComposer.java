...
public class DefaultComposer implements PDUComposer {
     ...
     * (non-Javadoc)
     * 
     * @see com.softtech.util.PDUComposer#composeHeader(int, int, int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.softtech.util.PDUComposer#bind(int, int, java.lang.String,
     ...
     * (non-Javadoc)
     * 
     * @see com.softtech.util.PDUComposer#bindResp(int, int, java.lang.String,
     ...
     * (non-Javadoc)
     * 
     * @see com.softtech.util.PDUComposer#unbind(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.softtech.util.PDUComposer#unbindResp(int, int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.softtech.util.PDUComposer#outbind(int, java.lang.String,
     *      java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.softtech.util.PDUComposer#enquireLink(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.softtech.util.PDUComposer#enquireLinkResp(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.softtech.util.PDUComposer#genericNack(int, int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.softtech.util.PDUComposer#submitSm(int, java.lang.String, byte,
     ...
     * (non-Javadoc)
     * 
     * @see com.softtech.util.PDUComposer#submitSmResp(int, java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.softtech.util.PDUComposer#querySm(int, java.lang.String, byte,
     ...
     * (non-Javadoc)
     * 
     * @see com.softtech.util.PDUComposer#querySmResp(int, java.lang.String,
     ...
     * (non-Javadoc)
     * 
     * @see com.softtech.util.PDUComposer#deliverSm(int, java.lang.String, byte,
     *      byte, java.lang.String, byte, byte, java.lang.String, byte, byte,
     *      byte, byte, byte, byte[], com.softtech.bean.OptionalParameter[])
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.softtech.util.PDUComposer#deliverSmResp(int, int, String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.softtech.util.PDUComposer#dataSm(int, java.lang.String, byte, byte,
     ...
     * (non-Javadoc)
     * 
     * @see com.softtech.util.PDUComposer#dataSmResp(int, java.lang.String,
     *      com.softtech.bean.OptionalParameter[])
     */

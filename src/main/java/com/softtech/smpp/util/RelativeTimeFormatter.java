...
public class RelativeTimeFormatter implements TimeFormatter {
    ...
    private static TimeZone utcTimeZone = TimeZone.getTimeZone("IST");
     ...
     * @return The relative time between the calendar date and the SMSC calendar
     * date.
     */
    ...
    /**
     * Return the relative time from the calendar datetime against the SMSC
     * datetime.
     *
